...
export const UserHome = () => {
  ...
  useEffect(() => {
    if (!sessionStorage.getItem('welcome_shown')) {
      toast({
        title: 'Welcome back!',
        description: 'You’ve successfully logged in to SmartHire.',
        duration: 2500,
      });
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            ...
            <div className="inline-flex items-center gap-2.5 bg-white/90 backdrop-blur-md px-6 py-3 rounded-full border border-blue-100 mb-7 shadow-lg hover:shadow-xl transition-all duration-300 animate-in slide-in-from-top duration-700">
              ...
              <span className="text-sm font-medium text-gray-700">Welcome to SmartHire</span>
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-10 max-w-3xl mx-auto leading-relaxed animate-in slide-in-from-top duration-700 delay-400">
              Explore {allJobs.length} curated job opportunities from top companies and accelerate your professional journey.
            </p>
            ...
            <div className="max-w-4xl mx-auto mb-12 animate-in slide-in-from-bottom duration-700 delay-500">
              <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-4 md:p-7 border border-white/50 shadow-2xl hover:shadow-3xl transition-shadow duration-300">
                <div className="flex flex-col gap-5">
                  ...
                  <div className="flex flex-wrap justify-center gap-3">
                    {['Remote Jobs', 'Full-Time', 'Tech Jobs', 'High Salary'].map((tag) => (
                      <Badge
                        key={tag}
                        variant="outline"
              ...
              {showResults && searchResults.length > 0 && (
                <div className="mt-4 bg-white/95 backdrop-blur-lg rounded-2xl border border-gray-200 shadow-2xl max-h-96 overflow-auto animate-in slide-in-from-bottom duration-300">
                  <div className="p-5">
                    <h3 className="font-semibold text-gray-800 mb-3 text-sm uppercase tracking-wide">Results ({searchResults.length})</h3>
                    <div className="space-y-3">
                      {searchResults.slice(0, 5).map((job) => (
                        <Link to="/user/jobs" key={job.id} className="block">
                          <div className="p-3.5 hover:bg-blue-50 rounded-xl transition-all duration-200 group cursor-pointer">
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-100">
                      <Link to="/user/jobs">
                        <Button variant="outline" className="w-full rounded-xl text-sm font-medium hover:bg-gray-50 transition-colors">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-in slide-in-from-bottom duration-700 delay-800">
              {[
                { icon: Target, title: "Smart Matches", desc: "AI-powered job recommendations", color: "from-blue-500 to-cyan-500" },
                { icon: Zap, title: "One-Click Apply", desc: "Fast, seamless applications", color: "from-purple-500 to-pink-500" },
                { icon: MessageSquare, title: "Real-Time Alerts", desc: "Get updates instantly", color: "from-green-500 to-emerald-500" },
                { icon: Award, title: "Career Progress", desc: "Track your growth journey", color: "from-orange-500 to-yellow-500" }
              ].map((feature, index) => (
                <Card 
                  key={index} 
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-14">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Why Choose SmartHire?</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Data-driven success. Trusted by thousands.</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-6 sm:px-8 lg:px-12">
          <div className="text-center mb-14">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">Handpicked roles to jumpstart your career</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
            {featuredJobs.map((job) => (
              <Card 
                key={job.id} 
                className="hover:shadow-2xl transition-all duration-300 hover:shadow-blue-100 border border-gray-100 bg-white rounded-2xl overflow-hidden"
              >
          ...
          <div className="text-center">
            <Link to="/user/jobs">
              <Button 
                size="lg" 
                className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-6 rounded-xl shadow-md hover:shadow-lg transition-all font-medium"
              >
                Explore All Jobs
              </Button>
            </Link>
