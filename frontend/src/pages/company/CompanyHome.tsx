          ...
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="mb-12">
              ...
              <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in" style={{ animationDelay: '0.3s' }}>
                Post jobs, review applications, and hire the best candidates for your company.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in" style={{ animationDelay: '0.8s' }}>
              {[
                { icon: Target, title: "Personalized Matches", desc: "AI matches jobs to top candidates", color: "from-blue-500 to-cyan-500" },
                { icon: Zap, title: "Quick Posting", desc: "Post jobs with one click", color: "from-purple-500 to-pink-500" },
                { icon: MessageSquare, title: "Real-time Updates", desc: "Get notified of new applications", color: "from-green-500 to-emerald-500" },
                { icon: Award, title: "Company Growth", desc: "Track your hiring progress", color: "from-orange-500 to-yellow-500" }
              ].map((feature, index) => (
                <Card 
                  key={index} 
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Company Portal Stats</h2>
